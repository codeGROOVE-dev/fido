...
require (
	github.com/codeGROOVE-dev/multicache/pkg/store/compress v1.6.1
	github.com/codeGROOVE-dev/multicache/pkg/store/datastore v1.6.1
	github.com/codeGROOVE-dev/multicache/pkg/store/localfs v1.6.1
)
